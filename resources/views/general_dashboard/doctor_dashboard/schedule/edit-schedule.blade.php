        ...
        <div class="content">
            ...
            <div class="row align-items-center justify-content-between mb-4 breadcrumbs-div">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('my-schedule.index') }}" class="btn btn-danger btn-rounded"><i class="fa fa-ban"></i>
                        Cancel</a>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="in" class="form-control" value="{{ $schedule->in }}"
                                        placeholder="Select Your Date" id="schedule_date">
                                    @error('in')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="from" class="form-control" id="start_time" value="{{ $schedule->from }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="to" class="form-control" id="end_time" value="{{ $schedule->to }}"
