                                        ...
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="{{ route('doctor.show', ['doctor' => $doctor->id]) }}"
                                                    ...
                                                    <img src="{{ asset($doctor->profile) }}" alt="" width="34"
                                            ...
                                            <div class="contact-info">
                                                <a href="{{ route('doctor.show', ['doctor' => $doctor->id]) }}"
                                                    title="Click to view profile">
                                                    <span class="contact-name text-ellipsis">{{ $doctor->first_name }}
                                                        {{ $doctor->middle_name }} {{ $doctor->last_name }}</span>
                                                </a>
                                                <span
                                                    class="contact-date">{{ $doctor->educations[0]->medical_degree }}</span>
                                            </div>
                                        </div>
                                    </li>
                                @endforeach
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="flex-equal">
                                    {!! Form::select(
                                        ...
                                        session('departmentId') ? session('departmentId')->id : '',
                                        [
