        ...
        <div class="content">
            <div class="row align-items-center justify-content-between mb-4 breadcrumbs-div">
                ...
                <div class="col-sm-6 text-right">
                    <a class="btn btn-danger btn-lg btn-rounded" href="{{ route('doctor.index') }}"><i class="fa fa-ban"
                            aria-hidden="true"></i> Cancel</a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <form method="POST" action="{{ route('doctor.update', ['doctor' => $doctor_basic->id]) }}"
                        id="wizardForm" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <!-- Basic Details -->
