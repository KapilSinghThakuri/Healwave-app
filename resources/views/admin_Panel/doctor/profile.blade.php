        ...
        <div class="content">
            ...
            <div class="row align-items-center justify-content-between mb-4 breadcrumbs-div">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('doctor.index') }}" class="btn btn-danger btn-rounded"><i class="fa fa-chevron-left"
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="profile-info-left">
                                            ...
                                            @can('edit doctor')
                                                <div class="staff-msg">
                                                    <a href="{{ route('doctor.edit', ['doctor' => request()->route('doctor')]) }}"
                                        ...
                                        <ul class="personal-info">
                                            <li>
                                                ...
                                                <span class="text"><a href="#"
                                                        class="text-secondary">{{ $doctor_basic->phone }}</a></span>
                                            </li>
                                            <li>
                                                <span class="title">Email:</span>
                                                <span class="text"><a href="#"
                                                        class="text-secondary">{{ $doctor_basic->email }}</a></span>
                                            </li>
                                            <li>
                                    ...
                                    <div class="col-md-6">
                                        <div class="address-section">
                                            ...
                                            <div class="address-info">
                                                ...
                                                <p>Municipality :
                                                    {{ $temp_municipality->{'municipality_name[nep]'} ?? '' }}</p>
