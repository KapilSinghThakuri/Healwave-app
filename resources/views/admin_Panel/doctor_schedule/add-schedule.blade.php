                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::select('days[]', config('dropdown.doctorScheduleDays'), null, ['class' => 'form-control mutiple-value-select', 'multiple' => 'multiple']) }}
                                    @error('days')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="total_quota" class="form-control" placeholder="Enter Total Quota"
                                        id="total_quota" value="{{ old('total_quota') }}">
                                    @error('total_quota')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="from" class="form-control" id="start_time"
                                        placeholder="Select Start Time" value="{{ old('from') }}">
                                    @error('from')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>End Time</label><span class="text-danger">*</span>
