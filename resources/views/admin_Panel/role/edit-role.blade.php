            ...
            <div class="content">
                <div class="row align-items-center justify-content-between mb-4 breadcrumbs-div">
                    ...
                    <div class="col-sm-6 text-right">
                        <a href="{{ route('role.index') }}" class="btn btn-danger btn-rounded"><i class="fa fa-ban"
                                ...
                                <form method="POST" action="{{ route('role.update', ['role' => $role->id]) }}">
                                    ...
                                    @php
                                        $modules = [
                                            [
                                                'name' => 'Role Module',
                                                'permissions' => $permissions->take(4),
                                            ],
                                            [
                                                'name' => 'User Module',
                                                'permissions' => $permissions->skip(4)->take(4),
                                            ],
                                            [
                                                'name' => 'Department Module',
                                                'permissions' => $permissions->skip(8)->take(4),
                                            ],
                                            [
                                                'name' => 'Doctor Module',
                                                'permissions' => $permissions->skip(12)->take(4),
                                            ],
                                            [
                                                'name' => 'Schedule Module',
                                                'permissions' => $permissions->skip(16)->take(4),
                                            ],
                                            [
                                                'name' => 'Patient Module',
                                                'permissions' => $permissions->skip(20)->take(4),
                                            ],
                                            [
                                                'name' => 'Appointment Module',
                                                'permissions' => $permissions->skip(24)->take(4),
                                            ],
                                        ];
                                    @endphp
                                    <div class="row">
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <p class="ml-3 permission_name text-primary"
                                                                style="font-weight: 400;">{{ $module['name'] }}</p>
                                                        </div>
                                                    </div>
