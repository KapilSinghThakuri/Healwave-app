...
<div class="page-wrapper">
    <div class="content">
                ...
                <div class="col-md-3">
                    <div class="photo-card">
                        ...
                        <div class="delete-button text-center">
                            <a href="#" data-id="{{ $photo->id }}" data-toggle="modal"
                                data-target="#delete_photo_{{ $photo->id }}" style="font-size: 20px; color: red;"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                <img src="{{ asset('admin_Assets/img/sent.png') }}" alt="" width="50"
                                    height="46">
                                <h3>Are you sure want to delete this Photo?</h3>
                                <div class="m-t-20 d-flex justify-content-center"> <a href="#"
                                        class="btn btn-white mr-2" data-dismiss="modal">Cancel</a>
                                    <form action="{{ route('gallery.destroy', ['gallery' => $photo->id]) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
        ...
        <form method="POST" action="{{ route('gallery.store') }}" enctype="multipart/form-data">
            ...
            <div class="row mt-5" id="addphotos">
                <div class="col-lg-3">
                ...
                <div class="col-md-3">
                    <div class="form-group d-flex flex-column">
                        ...
                        <div class="d-flex mt-1">
                            <span class="btn btn-primary btn-sm" id="image"><i class="fa fa-file-image-o"
                                    aria-hidden="true"></i> Image</span>
                            <span class="btn btn-primary btn-sm ml-2" id="video"><i class="fa fa-video-camera"
